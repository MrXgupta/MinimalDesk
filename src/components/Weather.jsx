...
const Weather = () => {
    ...
    return (
        <div className="group relative bg-white/10 text-white rounded-md px-4 py-2 text-sm w-[260px] overflow-visible hover:bg-white/20 transition-all duration-300">
            ...
            {/* Hover 7-day forecast */}
            <div className="absolute top-full left-0 w-[260px] opacity-0 group-hover:opacity-100 translate-y-1 group-hover:translate-y-2 transition-all duration-300 z-50">
                <div className="bg-transparent border border-white/20 p-2 mt-2 rounded-md shadow-lg grid grid-cols-2 gap-2 text-xs">
